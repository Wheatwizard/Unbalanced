...
helpMenu :: String
helpMenu = unlines ["",
  "Unbalanced Haskell Interpreter",
  "Usage:",
  "\tUnbalanced [options] source_file args...",
  "",
  "   -a, --ascii-out\t\tOutputs as ascii character codes.",
  "   -e, --execute\t\tExecutes the first commandline argument as Unbalanced code.",
...
main = do 
 ...
 putStr$ (if exiting then
           ...
           concat (map formatOutput (interpret source (processInput (tail args))))
          )
